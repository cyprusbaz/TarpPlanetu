document.addEventListener('DOMContentLoaded', function() {
    ...
    const planButton = document.querySelector('.action-buttons .action-button:first-child');
    const listButton = document.querySelector('.action-buttons .action-button:last-child');
    
    planButton.addEventListener('click', function() {
      alert('Kuriamas naujas kelionės planas');
    });
    
    listButton.addEventListener('click', function() {
      alert('Peržiūrimas kelionių sąrašas');
    });
    ...
    const orderButton = document.querySelector('#jupiter .planet-button:first-child');
    ...
    const removeButton = document.querySelector('#jupiter .planet-button.outline');
